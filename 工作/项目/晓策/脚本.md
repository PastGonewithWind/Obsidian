...
create table tag_categories_his  
(  
HIS_ID varchar(36) not null comment '历史guid' primary key,  
HIS_LOGTIME datetime not null comment '历史记录生成事件',  
HANDLE_TYPE int null comment '操作类型1: 新增 2：修改 3： 删除',  
CATEGORY_ID varchar(36) not null comment '标签类型ID',  
CATEGORY_NAME varchar(50) not null comment '标签类型名称',  
TYPE_NAME varchar(200) not null comment '标签类型 staff_tags/customer_tags',  
CATEGORY_DESC varchar(50) null comment '标签描述',  
PARENT_ID varchar(36) null comment '父节点ID',  
CREATED_BY varchar(6) not null comment '创建人',  
CREATED_TIME datetime default CURRENT_TIMESTAMP null comment '创建时间',  
MODIFIED_BY varchar(6) not null comment '修改人',  
MODIFIED_TIME datetime default CURRENT_TIMESTAMP null comment '修改时间',  
IS_DELETED int default 0 null comment '是否删除 1 已删除 0 未删除'  
) comment '标签分类表历史';
...
TAG_NAME varchar(50) not null comment '标签名称',  
CATEGORY_ID varchar(36) null comment '标签类型ID',  
TAG_COLOR varchar(10) null comment '标签颜色',  
TAG_BG_COLOR varchar(10) null comment '标签背景颜色',  
IS_PUBLIC tinyint(1) null comment '1 是公共标签 0是个人标签',  
CREATED_BY varchar(6) not null comment '创建人',  
CREATED_TIME datetime default CURRENT_TIMESTAMP null comment '创建时间',  
MODIFIED_BY varchar(6) not null comment '修改人',  
MODIFIED_TIME datetime default CURRENT_TIMESTAMP null comment '修改时间',  
...
create table tag_staff_his  
(  
HIS_ID varchar(36) not null comment '历史guid' primary key,  
HIS_LOGTIME datetime not null comment '历史记录生成事件',  
HANDLE_TYPE int null comment '操作类型1: 新增 2：修改 3： 删除',  
ID varchar(36) not null comment '坐席标签ID',  
TAG_ID varchar(50) not null comment '标签ID',  
relation_id varchar(6) null comment '关联字段，对应staff_id',  
CREATED_BY varchar(6) not null comment '创建人',  
CREATED_TIME datetime default CURRENT_TIMESTAMP null comment '创建时间',  
MODIFIED_BY varchar(6) not null comment '修改人',  
MODIFIED_TIME datetime default CURRENT_TIMESTAMP null comment '修改时间',  
...
(  
TYPE_ID varchar(36) not null comment '主键' primary key,  
...
create table tag_type_his  
(  
HIS_ID varchar(36) not null comment '历史guid' primary key,  
HIS_LOGTIME datetime not null comment '历史记录生成事件',  
HANDLE_TYPE int null comment '操作类型1: 新增 2：修改 3： 删除',  
TYPE_ID varchar(36) not null comment '标签类型id',  
TYPE_NAME varchar(200) not null comment '类型名称',  
TABLE_DESCRIPTION varchar(200) not null comment '标签表名',  
CREATED_BY varchar(6) not null comment '创建人',  
CREATED_TIME datetime default CURRENT_TIMESTAMP null comment '创建时间',  
...
```mysql
测试脚本
DELETE FROM fund_cust_transaction  
INSERT INTO zo.fund_cust_transaction (TRANSACTION_UID, CUSTOMER_UID, FUND_CODE, BUSINESS_TYPE, AMOUNT, UNITS_TRADED, TOTAL_FEE, UNIT_NET_VALUE, PROCESSING_STATUS, APPLICATION_DATE, CONFIRMATION_DATE, SALES_INSTITUTION)  
VALUES ('1', '1', '001180', '1', 44.00, 10.00, 2.00, 3.00, '1', '2024-03-14', '2024-03-14', '1');  
INSERT INTO zo.fund_cust_transaction (TRANSACTION_UID, CUSTOMER_UID, FUND_CODE, BUSINESS_TYPE, AMOUNT, UNITS_TRADED, TOTAL_FEE, UNIT_NET_VALUE, PROCESSING_STATUS, APPLICATION_DATE, CONFIRMATION_DATE, SALES_INSTITUTION)  
VALUES ('2', '1', '001180', '1', 4.00, 1.00, 2.00, 3.00, '1', '2024-03-13', '2024-03-13', '1');  
INSERT INTO zo.fund_cust_transaction (TRANSACTION_UID, CUSTOMER_UID, FUND_CODE, BUSINESS_TYPE, AMOUNT, UNITS_TRADED, TOTAL_FEE, UNIT_NET_VALUE, PROCESSING_STATUS, APPLICATION_DATE, CONFIRMATION_DATE, SALES_INSTITUTION)  
VALUES ('3', '1', '001180', '1', 4.00, 1.00, 2.00, 3.00, '1', '2024-03-16', '2024-03-16', '1');  
INSERT INTO zo.fund_cust_transaction (TRANSACTION_UID, CUSTOMER_UID, FUND_CODE, BUSINESS_TYPE, AMOUNT, UNITS_TRADED, TOTAL_FEE, UNIT_NET_VALUE, PROCESSING_STATUS, APPLICATION_DATE, CONFIRMATION_DATE, SALES_INSTITUTION)  
VALUES ('4', '1', '001180', '1', 4.00, 1.00, 2.00, 3.00, '1', '2024-03-15', '2024-03-15', '1');  
DELETE FROM fund_bill_sendlist;  
INSERT INTO fund_bill_sendlist (BILL_UID, CUSTOMER_UID, BILL_TYPE, START_DATE, END_DATE, BILL_STATUS, CHECKD_BY, CREATED_BY, CREATED_TIME, MODIFIED_BY, MODIFIED_TIME, IS_DELETE) VALUES ('345525010536960', '66660000000002', 'MSG', '2024-03-11', '2024-03-17', 1, null, 'M9OXRL', '2024-03-15 17:36:32', 'M9OXRL', '2024-03-15 17:36:32', 0);  
INSERT INTO fund_bill_sendlist (BILL_UID, CUSTOMER_UID, BILL_TYPE, START_DATE, END_DATE, BILL_STATUS, CHECKD_BY, CREATED_BY, CREATED_TIME, MODIFIED_BY, MODIFIED_TIME, IS_DELETE) VALUES ('345525144754688', '66660000000001', 'MAIL', '2024-03-11', '2024-03-24', 1, null, 'M9OXRL', '2024-03-15 17:36:47', 'M9OXRL', '2024-03-15 17:36:47', 0);

delete from fund_db_recommended
INSERT INTO fund_db_recommended (LIST_ID, FUND_CODE, DESCRIPTION, HIGHLIGHT, R_STATUS, R_ORDER, CREATED_BY, CREATED_TIME, MODIFIED_BY, MODIFIED_TIME, IS_DELETED) VALUES ('1dbac969-dc31-11ee-b244-0050568602ce', '001500', '对于未来10年的高价值股票投资组合', '金牛基金经理的王牌基金', 1, 2, 'JYT8N7', '2024-03-07 11:16:40', 'EJOFWB', '2024-03-07 13:52:07', 0);  
INSERT INTO fund_db_recommended (LIST_ID, FUND_CODE, DESCRIPTION, HIGHLIGHT, R_STATUS, R_ORDER, CREATED_BY, CREATED_TIME, MODIFIED_BY, MODIFIED_TIME, IS_DELETED) VALUES ('b3ef55d8-dc46-11ee-b244-0050568602ce', '001180', '医药卫生行业指数增强型基金', '医药大健康在未来会有强势潜力', 1, 1, 'EJOFWB', '2024-03-07 13:51:11', 'EJOFWB', '2024-03-07 14:00:57', 0);

INSERT INTO calendar (CALENDAR_ID, CALENDAR_TITLE, START_TIME, END_TIME, IS_ALLDAY, STAFF_ID, CALENDAR_GROUP)  
VALUES (UUID(), 'POC演示', current_date, current_date+1, 1, 'M9OXRL', 1);
